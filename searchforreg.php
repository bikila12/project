...
<body id="container">
    <div id="bod">
        ...
        <div id="spaceesh">
            <div id="aformsh">
                <center>
                    <h3><p style="background-color:#FFFFFF">THE FOLLOWING ARE THE DETAILS OF GRADUATE STUDENTS AS YOU SEARCHED</p></h3>
                </center>
                <form method="post" action="viewreg.php">
                    <table border="4" bgcolor="#FFFFCC" height="10%" width="10%" class="table">
                        ...
                        <?php
                            ...
                            include('searchdbcon.php'); // Assuming this includes connection details
